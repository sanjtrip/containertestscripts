...
/usr/local/bin/singularity pull chroma_3.43.0.sif docker://amdih/chroma:3.43.0
echo "=== Pull complete ===="
...
/usr/local/bin/singularity run --pwd /benchmark --writable-tmpfs chroma_3.43.0.sif run-benchmark --ngpus 1
